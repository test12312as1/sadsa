          ...
          <div className="bg-[#12121c] rounded-xl p-6 border border-gray-800/50">
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#0a0a14] border border-gray-800 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-purple-500"
                  required
                />
              </div>
              <div>
            ...
            <div className="space-y-4">
              {snapshots.map((snapshot, index) => (
                <div key={index} className="bg-[#0a0a14] rounded-lg p-4 border border-gray-800/50">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-[#12121c] border border-gray-700 rounded px-3 py-2 text-white text-sm focus:outline-none focus:border-purple-500"
                        placeholder="Stake"
                        required
                      />
                    </div>
